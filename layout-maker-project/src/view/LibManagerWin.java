 ...
 * @author Luiz
 */
public class LibManagerWin extends javax.swing.JDialog {

    BibliotecaControl ctr;
    int row_selected;
    int opt_select = 0;
    List list = null;

    public LibManagerWin(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        try {
            // Control
            ctr = new BibliotecaControl();
    ...
    public LibManagerWin(java.awt.Frame parent, boolean modal, boolean select) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Gerenciador de Bibliotecas");
        setResizable(false);
    ...
    private void btn_addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_addActionPerformed
        ...
        LibWin win = new LibWin(null, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LibManagerWin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LibManagerWin dialog = new LibManagerWin(new javax.swing.JFrame(), true);
