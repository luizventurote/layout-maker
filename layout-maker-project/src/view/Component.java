 ...
 * @author Luiz
 */
public class Component extends javax.swing.JDialog {

    /**
     * Creates new form Component
     */
    public Component(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Component dialog = new Component(new javax.swing.JFrame(), true);
